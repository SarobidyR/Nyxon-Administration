...
// Lit le pageTitle du store Zustand et met à jour document.title
const APP_NAME = import.meta.env.VITE_APP_NAME || 'Nyxon';
        ...
        <Routes>
          ...
          <Route element={<RequireAuth />}>
            <Route element={<Layout />}>
              ...
              {/* Dashboard & profil — tous les rôles */}
              ...
              {/* Clients, Commandes, Reçus — vendeur+ */}
              <Route element={<RoleGuard role="vendeur" />}>
                ...
                <Route path="commandes">
                  {/* IMPORTANT : "nouveau" doit être AVANT ":id" pour éviter le conflit de matching */}
                  <Route path="nouveau"  element={<CommandesForm />} />
              ...
              {/* Catalogue avancé & stock — manager+ */}
              <Route element={<RoleGuard role="manager" />}>
              ...
              <Route element={<RoleGuard role="admin" />}>
                ...
                {/* Stats système & stats user — superadmin uniquement */}
